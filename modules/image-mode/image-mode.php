...
function mpfy_im_map_location_custom_fields($custom_fields) {
	...
	$custom_fields['map_location_city']->help_text(''); // Quitamos el texto para futuras implementaciones
	// Ocultamos esto para que no pete por haberlo ocultado en /options/custom-fields.php
