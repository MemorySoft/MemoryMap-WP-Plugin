...
function mpfy_show_update_notice(){
	...
	echo '<div class="error"><p>Uyva, parece que este plugin necesita ser actualizado... <a href="mailto:desarrolloweb@memorysoft.net">Dale un toque a Memory Soft</a> para que pongan esto al día.</p></div>';
}
