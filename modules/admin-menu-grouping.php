...
function mpfy_amg_update_menu() {
    ...
    add_menu_page('MemoryMap', 'MemoryMap', 'manage_options', 'mapify.php', '', 'dashicons-location', '33.333');
    add_submenu_page('mapify.php', 'Filtros', 'Filtros', 'manage_options', 'edit-tags.php?taxonomy=location-tag');
}
